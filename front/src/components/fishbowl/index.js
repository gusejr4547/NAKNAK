	var camera, scene, renderer;
			...
			function init() {
				...
				var materials = [
					...
					loadTexture( 'img.png' ), // right
					loadTexture( 'img.png' ), // left
					loadTexture( 'img.png' ), // top
					loadTexture( 'img.png' ), // bottom
					loadTexture( 'img.png' ), // back
					loadTexture( 'img.png' ) // front
				...
				mesh = new THREE.Mesh(new THREE.SphereGeometry(500, 32, 32), new THREE.MultiMaterial(materials));
				mesh.scale.x = -1;
				scene.add(mesh);
				...
				renderer.setSize( halfWidth, halfHeight);
				// renderer.setSize( '500px', '500px' );
